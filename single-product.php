            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="index2.php">Pagina de tienda</a></li>        <!-- shop.html  -->
                        <li class="active"><a href="single-product.php">Articulos</a></li> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2>tienda de ventas de celulares online</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/product-thumb-1.jpg" class="recent-thumb" alt="">
                            <h2><a href="">Sony Smart TV - 2018</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$700.00</ins> <del>$100.00</del>
                            </div>                             
                        </div>
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/product-thumb-1.jpg" class="recent-thumb" alt="">
                            <h2><a href="">Sony Smart TV - 2019</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$700.00</ins> <del>$100.00</del>
                            </div>                             
                        </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="profile">
                                                ...
                                                <div class="submit-review">
                                                    ...
                                                    <p><label for="review">mensje</label> <textarea name="review" id="" cols="30" rows="10"></textarea></p>
                        ...
                        <div class="related-products-wrapper">
                            ...
                            <div class="related-products-carousel">
                                ...
                                <div class="single-product">
                                    ...
                                    <h2><a href="">Apple nuevo iphone 6</a></h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-menu">
                            ...
                            <ul>
                                ...
                                <li><a href="">Contactar al vendedor</a></li>
                                <li><a href="">portad</a></li>
                            </ul>                        
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-menu">
                            ...
                            <ul>
                                <li><a href="">telefono movil</a></li>
                                <li><a href="">accesorios de tienda</a></li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-newsletter">
                            <h2 class="footer-wid-title">informacion</h2>
                            <p>suscribase a nuesto pagina y obtenga ofertas exclusivas que no encontrara en ningun otro lugar directamente en su bandeja de entradad</p>
                            <div class="newsletter-form">
                                <input type="email" placeholder="escriba su e-mail">
